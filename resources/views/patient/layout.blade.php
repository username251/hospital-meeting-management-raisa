...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" loading="lazy" width="60">
        </div>
                    ...
                    @if(Auth::user()->patient)
                        <li class="nav-item dropdown user-menu">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ Auth::user()->patient->profile_picture ? asset('storage/' . Auth::user()->patient->profile_picture) : asset('admincss/dist/img/user2-160x160.jpg') }}" loading="lazy" class="user-image img-circle elevation-2" alt="User Image">
                                <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                <li class="user-header bg-primary"> {{-- Warna bisa disesuaikan (misal: bg-success, bg-teal) --}}
                                    <img src="{{ Auth::user()->patient->profile_picture ? asset('storage/' . Auth::user()->patient->profile_picture) : asset('admincss/dist/img/user2-160x160.jpg') }}" loading="lazy" class="img-circle elevation-2" alt="User Image">
                                    <p>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ route('patient.index') }}" class="brand-link"> {{-- Arahkan ke dashboard pasien --}}
                <img src="dist/img/AdminLTELogo.png" loading="lazy" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                @auth
                    ...
                    @elseif(Auth::check()) {{-- User login tapi bukan pasien --}}
                         <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                            <div class="image">
                                <img src="{{ asset('admincss/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" loading="lazy" alt="User Image">
                            </div>
                            <div class="info">
