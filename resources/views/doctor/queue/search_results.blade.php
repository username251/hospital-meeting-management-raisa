@extends('doctor.layout') {{-- Pastikan path ini benar --}}
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('doctor.queue.index') }}">Antrean Pasien</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('doctor.queue.index') }}" class="btn btn-secondary btn-sm">Kembali ke Antrean</a>
                    </div>
                </div>
                <div class="card-body">
