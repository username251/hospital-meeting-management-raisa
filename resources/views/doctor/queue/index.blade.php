@extends('doctor.layout') {{-- Pastikan path ini benar ke layout utama Staff Anda --}}
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="{{ route('doctor.queue.search') }}" method="GET">
                ...
                <div class="card card-outline card-primary highlight-patient">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <form action="{{ route('doctor.queue.callPatient', $nextPatient->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-phone"></i> Panggil Pasien Ini</button>
                            </form>
                            <a href="{{ route('doctor.appointments.edit', $nextPatient->id) }}" class="btn btn-warning btn-sm ml-2"><i class="fas fa-edit"></i> Edit Janji</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <form action="{{ route('doctor.queue.updateStatus', $nextPatient->id) }}" method="POST" class="mt-2">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="card card-queue-item status-{{ $appointment->status }} h-100">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                    <form action="{{ route('doctor.queue.updateStatus', $appointment->id) }}" method="POST" style="display:inline-block;">
                                                        @csrf
                                                        @method('PATCH')
