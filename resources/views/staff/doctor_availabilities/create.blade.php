...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Ketersediaan Dokter</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Ketersediaan Dokter</h3>
            </div>
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="doctor_id" id="doctor_id" class="form-control @error('doctor_id') is-invalid @enderror" required>
                            ...
                            @foreach($doctors as $doctor)
                                <option value="{{ $doctor->id }}" {{ old('doctor_id') == $doctor->id ? 'selected' : '' }}>{{ $doctor->user->name }} ({{ $doctor->specialty->name ?? 'N/A' }})</option>
                            @endforeach
                        </select>
                        @error('doctor_id')
